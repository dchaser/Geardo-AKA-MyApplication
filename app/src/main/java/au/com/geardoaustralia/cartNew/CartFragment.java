...
import au.com.geardoaustralia.cartNew.util.UIUtils;
import au.com.geardoaustralia.cartNew.widget.AddCartDialogActivity;
import au.com.geardoaustralia.cartNew.widget.CollectionView;
...
public class CartFragment extends Fragment /*implements LoaderManager.LoaderCallbacks<List<Product>>*/ {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mImageLoader = new ImageLoader(getActivity(), R.drawable.logo_geardo);
    }
    ...
    public static class CartListAdapter extends ArrayAdapter<Product> {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            if (TextUtils.isEmpty(item.imageUrlSmall)) {
                holder.thumbnailView.setImageResource(R.drawable.logo_geardo);
            } else {
