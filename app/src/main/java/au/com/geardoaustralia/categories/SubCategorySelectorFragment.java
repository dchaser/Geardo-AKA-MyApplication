...
public class SubCategorySelectorFragment extends CommonTabFragment {
    ...
    public SubCategorySelectorFragment() {
    ...
    private static class catFilterAdapter extends RecyclerView.Adapter<SubCategorySelectorFragment.catFilterAdapter.catFilterVH> implements Filterable {
        ...
        catFilterAdapter(List<categoryModel> myDataset, Context context) {
            ...
            subCategoryFilter = new SubCategorySelectorFragment.catFilterAdapter.subCategoryFilter();

        }

        @Override
        public SubCategorySelectorFragment.catFilterAdapter.catFilterVH onCreateViewHolder(ViewGroup parent,
                                                                                           int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.subcategory_view, parent, false);
            SubCategorySelectorFragment.catFilterAdapter.catFilterVH vh = new SubCategorySelectorFragment.catFilterAdapter.catFilterVH(v);
            return vh;
        }


        @Override
        public void onBindViewHolder(SubCategorySelectorFragment.catFilterAdapter.catFilterVH holder, int position) {
