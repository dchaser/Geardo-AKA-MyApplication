package au.com.geardoaustralia.mymultiselect;
...
import au.com.mymultiselect.adapter.SimpleStringRecyclerViewAdapter;
import au.com.mymultiselect.base.BaseActivity;
import au.com.mymultiselect.widget.DividerItemDecoration;

/**
 * Created by Ben Murphy on 8/7/15.
 *
 */
public class MultiWithoutContextualActionBarActivity extends BaseActivity {
    ...
    protected void setupHomeUp() {
        ...
        ab.setTitle("Multi w/o CAB");
    }

    @Override
    protected int getNavigationSelectedPosition() { return 2; }

    @Override
    protected int getNavigationMenuItemId() { return R.id.nav_multi_wo_cab; }
    ...
    private void setupRecyclerView(@IdRes int id, @Nullable Bundle bundle) {
        ...
        SimpleStringRecyclerViewAdapter.HELPER_MULTI_WITHOUT_CAB));
